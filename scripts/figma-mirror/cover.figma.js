...
globalThis.__cover = (() => {
  ...
  async function overview(n) {
    ...
    await text(tree, ['04-figma-sds-custom/', '├── src/theme.css              tokens, generated by Figma’s script — the source here', '├── src/ui/primitives/         28 component folders, React Aria + plain CSS', '├── src/ui/compositions/       cards, forms, headers, footers, sections', '├── src/ui/icons/              287 icons', '├── src/stories/               Figma’s stories', '├── src/stories/_course/     ＋ Getting started, Foundations, the Mirror harness', '├── src/figma/                 Figma’s Code Connect files (they point at Figma’s own file)', '├── scripts/figma-mirror/    ＋ tokens, icons, probe, builder, cover, upstream check', '├── figma/                   ＋ contracts.json, GAPS.md, manifest.json', '├── docs/decisions.md        ＋ decisions and why', '└── COURSE-NOTES.md          ＋ what was added, and how updates come in'].join('\n'), 'font/body-code');
